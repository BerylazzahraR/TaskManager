...
class TeamController extends Controller
{
    ...
    public function show(Request $request, string $slug) // Pastikan ada (Request $request) di sini
    {
        ...
        // Lempar filter ke getTasks
        $tasks = $this->teamQuery->getTasks($team->id, $filters);
